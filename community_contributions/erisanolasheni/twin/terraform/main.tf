# Week 2 Day 4 — based on course twin stack.
# Fixes: no Lambda depends_on CloudFront; CORS_ORIGINS=* on Lambda; managed CloudFront policies by name.
...
resource "aws_cloudfront_distribution" "main" {
  ...
  viewer_certificate {
    ...
    acm_certificate_arn            = try(aws_acm_certificate.site[0].arn, null)
